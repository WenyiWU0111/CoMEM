...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, 
    ...
    if 'lora' in model_name.lower() and model_base is not None:
        ...
        print('Loading Qwen2.5-VL-LLM from base model...')
        model = Qwen2_5_VLForConditionalGeneration_new_llm.from_pretrained(model_base, low_cpu_mem_usage=True, config=lora_cfg_pretrained, **kwargs)
