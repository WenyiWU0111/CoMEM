...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="rag", help="baseline or steered")
    ...
    for i in range(selected_batch_data.shape[0]):
        ...
        ans = generate_response_rag(args.model_name, processor, model, image, prompt, similar_infos)
