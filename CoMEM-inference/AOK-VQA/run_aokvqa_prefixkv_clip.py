...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="prefixkv", help="rag_direct or rag_direct_mcq")
    ...
    parser.add_argument("--prefix-idx", type=list, default=[17,18,19])
    parser.add_argument("--top-tokens", type=int, default=75)
    ...
    output_file_path = os.path.join(args.output_dir, "okvqa_{}_{}_{}_{}_{}_{}.jsonl".format(
                args.model_name, args.model_type, args.similar_num, args.prefix_idx, args.top_tokens, args.pool))
    ...
    for i in range(selected_batch_data.shape[0]):
        ...
        prefix_kvs = [get_past_key_value_text(processor, tokenizer, model, value['image'], value['desc'], args.prefix_idx, args.top_tokens, pool=args.pool) for value in similar_infos.values()]
